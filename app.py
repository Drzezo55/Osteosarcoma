...
model = joblib.load('C:/Users/ascom/Desktop/new paid/lgb_reg.pkl')
...
Site = st.selectbox("Primary Site", ['C71.1-Frontal lobe', 'C71.2-Temporal lobe', 'C71.3-Parietal lobe',
                                      'C71.8-Overlapping lesion of brain', 'C71.0-Cerebrum', 'C71.9-Brain, NOS', 
                                      'C71.4-Occipital lobe', 'C71.6-Cerebellum, NOS', 'C71.7-Brain stem', 'C72.0-Spinal cord',
                                        'C71.5-Ventricle, NOS', 'C72.3-Optic nerve'])
SEER_Stage = st.selectbox("Stage", ['Localized', 'Regional', 'Distant'])
